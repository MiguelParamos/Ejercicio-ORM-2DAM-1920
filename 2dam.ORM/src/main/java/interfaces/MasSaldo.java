			...
			public void actionPerformed(ActionEvent arg0)
			{
				...
				try
				{
					...
					if (saldoAAnadir + v.getUsu().getSaldo() < 2000000000L)
					{
						...
						{
							// Si todo ha ido bien hasta este punto se le a�ade el saldo al usuario y se
							// actualiza la ventana
							float newBal = (float) (saldoAAnadir + getUsuario().getSaldo());
							v.getUsu().setSaldo(newBal);
							getLblSaldoAnadido().setText("Saldo a�adido correctamente");
